...
class NaasAuth(InDriver, OutDriver):
    ...
    def connect(self, token=None):
        ...
        res = r.get(f'{AUTH_API_PROTOCOL}://{AUTH_API_FQDN}/bearer/jupyterhubtoken',
                    params={'token': token}
        )
    ...
    class Users(__InnerBase):
        ...
        def me(self):
            res = r.get(f'{AUTH_API_PROTOCOL}://{AUTH_API_FQDN}/users/me/',
    ...
    class Bearer(__InnerBase):
        ...
        def validate(self):
            res = r.get(f'{AUTH_API_PROTOCOL}://{AUTH_API_FQDN}/bearer/validate',
                headers=self.headers
